...
$(document).ready(function () {
  ...
  $('.tm-product-card').each(function () {}); //Deposit/transfer animation
  ...
  setInterval(function () {
    langAnim();
  }, 12000); // Add smooth scrolling to all links
  ...
  $('.lang-trigger').on('click', function () {
    ...
    return false; //$('.tm-language-select-panel').fadeIn();
...
if ($('.tm-ao-form-container').length) {
  var onSubmit = function onSubmit(token) {
    document.getElementById("demo-form").submit();
  }; //submit


  var formTipsContent = function formTipsContent(_text) {
...
if ($('.australian-open-landing-language').length) {
  ...
  var widget = AcuityWidgets.CreateWidget('australianopenlanding', document.getElementById('australian-open-landing'), {
    'gender': queryGroup,
...
!function (t, e) {
  "object" == ( false ? 0 : _typeof(exports)) ? module.exports = e(t) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_FACTORY__ = (e),
		__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
		(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
		__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : 0;
}("undefined" != typeof __webpack_require__.g ? __webpack_require__.g : this.window || this.global, function (t) {
  "use strict";
...
/*!******************************!*\
  ...
  \******************************/
__webpack_require__(/*! ./lazyload.min */ "./resources/js/lazyload.min.js");
...
function socketApi(obj) {
  if ($(obj).length > 0) {
    ...
    socketRes.onmessage = function (e) {
      _html($(obj), e);
    };
  }
}
...
var _url = decodeURIComponent(window.location.search);

if (_url && decodeURIComponent(window.location.href).indexOf('expiry_date') !== -1) {
  var temp = _url.split('?')[1].split('&'),
      a = temp[0].split('='),
