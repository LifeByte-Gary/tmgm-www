    ...
    <div class="tm-main-banner" style="background-image:url({{ asset('img/banner-img-bk.jpg') }})">
        <div class="tm-container flx">
            <div class="tm-banner-content">
                ...
                <div class="tm-btn-wrapper"><a href="https://portal.tmgm.com/register?language=zh" target="_blank"
                                               class="btn-big white">即刻开始交易</a>
                    或 <a href="https://portal.tmgm.com/register?register_type=demo&amp;language=zh" target="_blank"
                         class="text-link">试用模拟账号</a></div>
